...
4. **Human Accountability** – Humans approve all critical milestones (Specification approval, Architecture sign‑off, Release readiness). Models provide recommendations only.
...
- **Human Approval Gates** – Specification, Architecture, Deployment Ready, and Passport generation each require explicit human approval.
