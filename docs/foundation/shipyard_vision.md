...
The user interacts through a minimal chat interface:
...
No dashboards, model selections, or workflow editors are exposed. The system guides the user toward a **validated Engineering Specification**. **Once approved, Shipyard behaves like a professional engineering organization—keeping the user informed, requesting decisions only when necessary, and completing the engineering workflow autonomously.**
